    ...
    <div className="course-preview">
      <div className="course-preview__container">
        ...
        <div>
          ...
          <p className="text-sm text-sky-600">{course.description}</p>
        </div>
        <div>
          <h4 className="text-white font-semibold mb-2">Course content</h4>
          <AccordionSections sections={course.sections} />
        </div>
      </div>
      <div className="course-preview__container">
        <h3 className="text-xl mb-4">Price detail (1 item)</h3>
